...
all_rooms = {
	"oval" 				=>	Room.new(oval_desc				,oval_err					,oval_dirs				),
	"cent_hall_e" => 	Room.new(cent_hall_e_desc	,cent_hall_e_err	,cent_hall_e_dirs	),
	"cent_hall_w" => 	Room.new(cent_hall_w_desc	,cent_hall_w_err	,cent_hall_w_dirs	),
	"balcony" 		=> 	Room.new(balcony_desc			,balcony_err			,balcony_dirs			),
	"kitchen"			=> 	Room.new(kitchen_desc			,kitchen_err			,kitchen_dirs			),
	"dressing"		=> 	Room.new(dressing_desc		,dressing_err			,dressing_dirs		),
	"dining"			=> 	Room.new(dining_desc			,dining_err				,dining_dirs			),
	"pres_bed"		=> 	Room.new(pres_bed_desc		,pres_bed_err			,pres_bed_dirs		),
	"sitting_w"		=> 	Room.new(sitting_w_desc		,sitting_w_err		,sitting_w_dirs		),
	"sit_priv"		=> 	Room.new(sit_priv_desc		,sit_priv_err			,sit_priv_dirs		),
	"west"				=> 	Room.new(west_desc				,west_err				 	,west_dirs				),
	"east"				=> 	Room.new(east_desc				,east_err					,east_dirs				),
	"treaty"			=> 	Room.new(treaty_desc			,treaty_err				,treaty_dirs			),
	"grand_stair"	=> 	Room.new(grand_stair_desc	,grand_stair_err	,grand_stair_dirs	),
	"sitting_e"		=> 	Room.new(sitting_e_desc		,sitting_e_err		,sitting_e_dirs		),
	"lincoln_bed" => 	Room.new(lincoln_bed_desc	,lincoln_bed_err	,lincoln_bed_dirs	),
	"queens_bed"	=> 	Room.new(queens_bed_desc	,queens_bed_err		,queens_bed_dirs	),
	"sit_queen"		=> 	Room.new(sit_queen_desc		,sit_queen_err		,sit_queen_dirs		),
	"sit_linc"		=> 	Room.new(sit_linc_desc		,sit_linc_err			,sit_linc_dirs		),
	"hall_north"	=> 	Room.new(hall_north_desc	,hall_north_err		,hall_north_dirs	)
}
