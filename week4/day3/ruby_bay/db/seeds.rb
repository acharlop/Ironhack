...
prod1 = Product.create(user: use1, price: 100000, title: "Brian", description: "Some awesome description", deadline: 1.day.ago)
prod2 = Product.create(user: use1, title: "Stuie", description: "Another awesome description", deadline: 2.days.from_now)
prod3 = Product.create(user: use1, price: 5, title: "The fat man", description: "Cant think of anything for this", deadline: 1.month.from_now)
...
prod5 = Product.create(user: use3, price: 20, title: "Strong paperboy", description: "blah blah blah", deadline: 1.hour.ago)
prod6 = Product.create(user: use4, price: 200, title: "Bird is the word", description: "Its my duty as a father", deadline: 2.minutes.from_now)
